...
describe('Insignia Endpoints', () => {
  ...
  describe('DELETE /api/insignias/:id', () => {
  ...
  describe('POST /api/insignias/:id/assign/:userId', () => {
  ...
  describe('DELETE /api/insignias/:id/assign/:userId', () => {
  ...
  describe('GET /api/insignias/user/:userId', () => {
    beforeEach(async () => {
